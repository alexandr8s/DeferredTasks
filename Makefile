...
# created to the list.
TESTS = DeferredTasksExecutor_gTest
...
# function.
#DeferredTasksExecutor.o : $(SOURCE_DIR)/DeferredTasksExecutor.cpp $(SOURCE_DIR)/DeferredTasksExecutor.h $(GTEST_HEADERS)
#	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(SOURCE_DIR)/DeferredTasksExecutor.cpp

DeferredTasksExecutor_gTest.o : $(TEST_DIR)/DeferredTasksExecutor_gTest.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) -I$(SOURCE_DIR) $(CXXFLAGS) -c $(TEST_DIR)/DeferredTasksExecutor_gTest.cpp

DeferredTasksExecutor_gTest : DeferredTasksExecutor_gTest.o gtest_main.a
